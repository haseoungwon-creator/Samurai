...
public static class StoryDatabase
{
    ...
    public static readonly Dictionary<string, List<Dialogue>> Stories = new()
    {
        ...
        [VILLAGE_TEACHER_17] = new List<Dialogue>()
        {
            ...
            new Dialogue("주인공", "...스승님? 스승님, 어디 계십니까! 사원이... 사원이 사라졌습니다!"),
            new Dialogue("스승", "..."),
            new Dialogue("주인공", "이 불길은... 이 잿더미는, 설마..."),
            new Dialogue("스승", "이제야, 눈을 뜨는구나."),
            new Dialogue("스승", "사원 같은 건 처음부터 없었다. 여기가... 언제나 여기였다."),
            new Dialogue("주인공", "아닙니다! 스승님은 살아 계십니다! 저는 지금도 스승님과 이야기를 나누고 있지 않습니까!"),
            new Dialogue("스승", "나는 이미 오래전에, 네 검에 죽었다."),
            new Dialogue("스승", "네가 이 잔향 속에서 베어 넘긴 건 괴물이 아니었다. 사람이었다. 나였고, 마을 사람들이었다."),
            new Dialogue("주인공", "...아니야. 아니야, 아니야!!"),
            new Dialogue("스승", "부정한다고 사라질 진실이었다면... 애초에 네게 보이지도 않았을 것이다."),
            new Dialogue("스승", "이제, 마주하거라. 나는... 더 해줄 말이 없다."),
            new Dialogue("스승", "(잿가루가 되어 흩날리며 사라진다)")
        },
