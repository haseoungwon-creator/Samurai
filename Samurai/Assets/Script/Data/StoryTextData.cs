...
public static class StoryDatabase
{
    ...
    public static readonly Dictionary<string, List<Dialogue>> Stories = new()
    {
        ...
        [VILLAGE_TEACHER_1] = new List<Dialogue>()
        {
            ...
            new("스승", "검사가 칼날에 잡념을 담으면 목숨을 잃는 법. 그 어지러운 호흡을 다스리기엔 지금 너의 칼끝이 너무 불안하구나."),
            new("주인공", "...가르침을 주십시오."),
            new("스승", "우선 마음을 진정시켜라. 본당 앞 마당에 세워둔 수련용 목석 더미를 모두 베어 넘기고 오거라."),
            new("스승", "호흡을 가다듬고, 검끝에 오직 하나만을 담아 베는 연습부터 다시 시작하도록."),
            new("주인공", "...알겠습니다. 다녀오겠습니다.")
        },

        [VILLAGE_TEACHER_2] = new List<Dialogue>()
        {
            new("주인공", "스승님, 수련용 목석을 모두 베어 넘겼습니다. 호흡도 다스렸습니다."),
            new("스승", "좋다. 칼끝의 떨림이 가라앉았구나. 하지만 참된 검은 정지된 목석이 아닌, 살아있는 실전에서 비로소 완성되는 법."),
            new("주인공", "실전... 말씀이십니까."),
            new("스승", "북쪽 대나무 숲 너머에 있는 '버려진 하천 사원(Abandoned River Shrine)'으로 가거라. 최근 그곳을 거점으로 삼은 무법자들과 들개들이 영역을 침범하고 있다."),
            new("스승", "그곳의 적들을 소탕하며, 네 검이 어떤 순간에도 흔들리지 않음을 증명하고 오거라."),
            new("주인공", "...명심하겠습니다. 다녀오겠습니다.")
        },
